...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/procurement-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-procurement-core:");
...
console.log("Documentation check passed for gutu-plugin-procurement-core.");
