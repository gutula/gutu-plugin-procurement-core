...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Procurement Control Room"),
    React.createElement("p", null, "Requisitions, purchase commitments, receipt expectations, and supplier-side exception posture."),
    React.createElement(
      "p",
      null,
